...
export interface ProfileSectionContextType {
	activeSection: string;
	setActiveSection: (section: string) => void;
}

export const ProfileSectionContext = createContext<ProfileSectionContextType | undefined>(undefined);
...
export default function ProfilePage() {
	...
	return (
		<ProfileSectionContext.Provider value={{ activeSection, setActiveSection }}>
