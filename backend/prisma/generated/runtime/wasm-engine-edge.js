...
function ue(t) {
  var e,
    ...
    s = t[0];
  if (i > 0) {
    for (o += s, e = 1; e < i; e++) ((n = t[e] + ''), (r = U - n.length), r && (o += Pe(r)), (o += n));
...
function hn(t, e) {
  ...
  for (e == null ? ((N = !1), (a = C)) : (a = e), s = new T(0.03125); t.abs().gte(0.1); ) ((t = t.times(s)), (h += 5));
...
function vr(t, e, r) {
  if (e > t.LN10.sd()) throw ((N = !0), r && (t.precision = r), Error(ie + 'LN10 precision limit exceeded'));
...
function it(t, e) {
  ...
  if ((e == null ? ((N = !1), (h = I)) : (h = e), R.eq(10))) return (e == null && (N = !0), vr(S, h));
...
function _(t, e, r) {
  ...
  if (
    ...
    return (
      f
        ? ((o = $(t)), (C.length = 1), (e = e - o - 1), (C[0] = ke(10, (U - (e % U)) % U)), (t.e = Ue(-e / U) || 0))
  ...
  if (
    (n == 0
      ? ((C.length = T), (o = 1), T--)
      : ((C.length = T + 1), (o = ke(10, U - n)), (C[T] = i > 0 ? ((h / ke(10, s - i)) % ke(10, i) | 0) * o : 0)),
    f)
  )
    for (;;)
      if (T == 0) {
  ...
  En = ne(() => {
    ...
    he = (function () {
      ...
      return function (n, i, o, s) {
        ...
        for (f = n.e - i.e, se = q.length, Se = le.length, R = new kt(zo), O = R.d = [], h = 0; q[h] == (le[h] || 0); )
          ++h;
        if (
          (q[h] > (le[h] || 0) && --f,
            ...
            ((T = 0),
              ...
              a < 0
                ? ((oe = S[0]),
                  ...
                  k < I && C.unshift(0),
                  r(S, C, I),
                  a == -1 && ((I = S.length), (a = e(q, S, se, I)), a < 1 && (T++, r(S, se < I ? St : q, I))),
                  (I = S.length))
                : a === 0 && (T++, (S = [0])),
              (O[h++] = T),
...
var zs = nt(Kn());
var Ys = { red: Ne, gray: Dn, dim: Lt, bold: _t, underline: Sn, highlightSource: (t) => t.highlight() },
