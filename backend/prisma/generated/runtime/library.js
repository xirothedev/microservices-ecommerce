...
`,
  ...
  function gp(e) {
    ...
    return r
      ? B._configVault(e)
      : (pp(`You set DOTENV_KEY but you are missing a .env.vault file at ${r}. Did you forget to build it?`),
        B.configDotenv(e));
  }
  function hp(e, r) {
...
var vr = 9e15,
  ...
  Bi = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -vr, maxE: vr, crypto: !1 },
  js,
  Le,
  w = !0,
  gn = '[DecimalError] ',
...
var Po,
  $l = {
    async loadLibrary(e) {
      ...
      if (t === void 0)
        throw new T(`The \`adapter\` option for \`PrismaClient\` is required in this context (${Bn().prettyName})`, r);
  ...
  class r {
    ...
    constructor(n) {
      ...
      let o = e.relativeEnvPaths && {
          ...
          schemaEnvPath:
            e.relativeEnvPaths.schemaEnvPath && ti.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
        },
        s;
      if (n?.adapter) {
        s = n.adapter;
