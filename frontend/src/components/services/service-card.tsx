			...
			<Card className="group h-full overflow-hidden border-0 shadow-md transition-all duration-300 hover:shadow-xl">
				...
				<div className="relative overflow-hidden">
					...
					<button
						...
						className="absolute top-3 right-3 rounded-full bg-white/90 p-2 backdrop-blur-sm transition-colors duration-200 hover:bg-white"
					>
				...
				<CardFooter className="pt-0">
					<div className="w-full space-y-3">
						<Button className="group w-full bg-blue-600 hover:bg-blue-700">
							Order Now
