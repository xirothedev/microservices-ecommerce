      ...
      function g(C) {
        ...
        for (j = 0; j < z; j += 4)
          ((A =
            ...
            (k[N++] = A & 255));
        return (
          L === 2 && ((A = (r[C.charCodeAt(j)] << 2) | (r[C.charCodeAt(j + 1)] >> 4)), (k[N++] = A & 255)),
          L === 1 &&
...
S.toDecimalPlaces = S.toDP = function (e, t) {
  ...
  return (
    (r = new n(r)),
    e === void 0 ? r : (se(e, 0, Be), t === void 0 ? (t = n.rounding) : se(t, 0, 8), I(r, e + r.e + 1, t))
  );
};
...
var $ = (function () {
  ...
  return function (n, i, o, s, a, l) {
    var u,
      ...
      B = i.d;
    if (!X || !X[0] || !B || !B[0])
      return new er(!n.s || !i.s || (X ? B && X[0] == B[0] : !B) ? NaN : (X && X[0] == 0) || !B ? Zr * 0 : Zr / 0);
    for (
    ...
    if (
      (B[h] > (X[h] || 0) && g--,
      o == null ? ((j = o = er.precision), (s = er.rounding)) : a ? (j = o + (n.e - i.e) + 1) : (j = o),
      j < 0)
    )
      (L.push(1), (C = !0));
    else {
          ...
          ((v = 0),
            ...
            u < 0
              ? ((z = k[0]),
                ...
                O < N && A.unshift(0),
                r(k, A, N, l),
                u == -1 && ((N = k.length), (u = t(B, k, Z, N)), u < 1 && (v++, r(k, Z < N ? Ye : B, N, l))),
                (N = k.length))
              : u === 0 && (v++, (k = [0])),
            (L[h++] = v),
...
function An(e, t, r, n) {
  var i,
    ...
    C = r !== void 0;
  if (
    (C ? (se(r, 1, Be), n === void 0 ? (n = R.rounding) : se(n, 0, 8)) : ((r = R.precision), (n = R.rounding)),
    !e.isFinite())
  )
    g = po(e);
  else {
    ...
    if (!h[0]) g = C ? '0p+0' : '0';
      ...
      if (
        (s < 0
          ? o--
          : ((e = new R(e)), (e.d = h), (e.e = o), (e = $(e, v, r, n, 0, i)), (h = e.d), (o = e.e), (u = no)),
        (s = h[r]),
        (a = i / 2),
        (u = u || h[r + 1] !== void 0),
        (u =
