...
export default function Pricing() {
	...
	return (
		<section id="pricing" className="bg-gray-50 py-20 transition-colors">
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="mx-auto max-w-3xl text-xl text-gray-600">
						Choose the perfect plan for your needs. All plans include our premium support and satisfaction
						guarantee.
					</p>
				</motion.div>
						...
						>
							<Card
								className={`relative h-full transition-all duration-300 hover:shadow-xl ${
									plan.popular ? "scale-105 ring-2 ring-blue-600" : ""
								}`}
							>
								{plan.popular && (
